...
const benefitTwo = {
  title: "And even more with MetaMatch...",
  image: benefitOneImg,
  bullets: [
    {
      title: "NFT Token",
      desc: "Mint NFT directly from files saved on MetaMatch ",
      icon: <DevicePhoneMobileIcon />,
    },
    {
      title: "Chat",
      desc: "Send messages with anyone you want using MetaMatch but you have to pay for it.",
