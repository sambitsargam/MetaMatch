          ...
          <li className="flex">
            ...
            >
              ...
              <img
                ...
                alt="Bonnie image"
              />
          <div className="text-gray-600 text-xl dark:text-gray-300">{address} </div>
          ...
          <li className="flex flex-row items-center">
            {web3Provider ? (
              ...
              >
                ...
                <select className="mr-2" defaultValue="bsc" style={{ width: 120 }} >
