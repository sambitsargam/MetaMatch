  ...
  return (
    <>
      <div className="bg-gray-800">
        ...
        <Hero />
        <SectionTitle
          pretitle="MetaMatch Benefits"
          title=" Why should you use MetaMatch"
        ></SectionTitle>
        <Benefits data={benefitOne} />
        <Benefits imgPos="right" data={benefitTwo} />
        <SectionTitle pretitle="about" title="Learn more about MetaMatch">
          MetaMatch a decentralise storage online Platforms with NFT and
